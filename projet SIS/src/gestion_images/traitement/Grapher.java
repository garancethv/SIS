...
import gestion_images.traitement.*;
...
public class Grapher extends JPanel {
    ...
    private boolean dessinerRectangle;
    ...
    protected Icon functions;

    public Grapher(Icon icon) {
        this.dessinerRectangle = false;
    ...
    public void setDessinerRectangle(boolean dessinerRectangle) {
...
//        }
        ...
        if (this.dessinerRectangle) {
            g2.draw(rect);
        }
    }

    public boolean getDessinerRectangle() {
